...
The [`AsyncCamera`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.AsyncCamera) runs in its own process using the Raspberry Pi `picamera2` library. Since `picamera2` is a blocking library, captures are run on a thread pool so the async event loop stays responsive.
...
The Arduino is connected over USB serial. The [`Client`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.Client) sends text commands and receives responses asynchronously.
...
| ------- | ------------ |
| [`verify_connection()`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.Client.verify_connection) | PING/PONG handshake to confirm the Arduino is connected |
| [`set_servo_angle()`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.Client.set_servo_angle) | Sets steering angle (clamped 0–180°) |
| [`set_motor_speed()`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.Client.set_motor_speed) | Sets drive speed (normalized −1 to 1) |
| [`drive_motors()`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.Client.drive_motors) | Sets both speed and angle at the same time |
...
## [`DriveCommandExecutor`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.DriveCommandExecutor)

The [`DriveCommandExecutor`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.DriveCommandExecutor) sits between the fast control loop and the slower serial link. The control loop can call [`submit()`](https://apostla-api-reference.web.app/interface.html#piclient.core.interface.DriveCommandExecutor.submit) every frame without ever waiting for the Arduino to respond.
