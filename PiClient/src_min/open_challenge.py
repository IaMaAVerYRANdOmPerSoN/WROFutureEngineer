    ...
    with Client() as client, Camera() as camera:
        ...
        try:
            while True:
                ...
                zone, walls, obstacles, corner_lines, wall_x_diffs, obstacle_dists = vision.comprehensive_analysis(
                    frame)
                    ...
                    case "Turn":
                        if not corner_lines:
                            ...
                            turn_correction = corner_turn_controller.tick(
                                ...
                                Config.OpenChallengeConfig.FRAME_CENTER_X
                            )  # Biggest corner line, frame center
                            client.drive_motors(
                                Config.OpenChallengeConfig.DRIVE_SPEED,
                                turn_correction,
                                Config.OpenChallengeConfig.DRIVE_COMMAND_DURATION,
